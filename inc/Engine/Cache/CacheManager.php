...
class CacheManager {
    ...
    public static function write_config_file( $purge_cache = false ) {
        ...
        $bypass_queries = array( 'wc-ajax', 'add-to-cart', 'pay_for_order', 'change_payment_method', 'logout', 'wc-api', 'magic_login', 'app', 'uxbuilder', 'uxbuilder_action', 'uxbuilder_iframe', 'uxb_iframe', 'post_id', 'elementor-preview', 'et_fb', 'vc_editable', 'ct_builder', 'bricks', 'fl_builder' );
        ...
        $config = array(
            ...
            'general_disable_xmlrpc'                  => intval( get_option( 'uwb_general_disable_xmlrpc', 0 ) ),
            'general_remove_jquery_migrate'           => intval( get_option( 'uwb_general_remove_jquery_migrate', 0 ) ),
            'general_hide_wp_version'                 => intval( get_option( 'uwb_general_hide_wp_version', 0 ) ),
            'general_remove_wlwmanifest'              => intval( get_option( 'uwb_general_remove_wlwmanifest', 0 ) ),
            'general_remove_rsd'                      => intval( get_option( 'uwb_general_remove_rsd', 0 ) ),
            'general_remove_shortlink'                => intval( get_option( 'uwb_general_remove_shortlink', 0 ) ),
            'general_disable_rss_feeds'               => intval( get_option( 'uwb_general_disable_rss_feeds', 0 ) ),
            'general_remove_rss_feed_links'           => intval( get_option( 'uwb_general_remove_rss_feed_links', 0 ) ),
            'general_disable_self_pingbacks'          => intval( get_option( 'uwb_general_disable_self_pingbacks', 0 ) ),
            'general_disable_rest_api'                => get_option( 'uwb_general_disable_rest_api', 'default' ),
            'general_remove_rest_api_links'           => intval( get_option( 'uwb_general_remove_rest_api_links', 0 ) ),
            'general_disable_google_maps'             => intval( get_option( 'uwb_general_disable_google_maps', 0 ) ),
            'general_disable_password_strength_meter' => intval( get_option( 'uwb_general_disable_password_strength_meter', 0 ) ),
            'general_disable_comments'                => intval( get_option( 'uwb_general_disable_comments', 0 ) ),
            'general_remove_comment_urls'             => intval( get_option( 'uwb_general_remove_comment_urls', 0 ) ),
            'general_add_blank_favicon'               => intval( get_option( 'uwb_general_add_blank_favicon', 0 ) ),
            'general_remove_global_styles'            => intval( get_option( 'uwb_general_remove_global_styles', 0 ) ),
            'general_disable_heartbeat'               => get_option( 'uwb_general_disable_heartbeat', 'default' ),
